...
const Footer = () => {
    ...
    return(
        <div className="absolute bottom-0 shadow-lg text-blue-800 border left-0 flex flex-col justify-between w-[100%] gap-1 font-mono items-center">
            <p>&copy; {date} TurkishFatma. All rights reserved.</p>
